...
export function FacebookEmbbedSignupButton({ minimal = false }: { minimal?: boolean }) {
  ...
  return (
    <button
      onClick={loginOnFacebook}
      className='inline-flex items-center gap-2 rounded-lg bg-green-600 px-4 py-2 text-sm font-medium text-white shadow-sm transition-all hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2'
    >
