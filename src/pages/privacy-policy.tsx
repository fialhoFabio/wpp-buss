    ...
    <div className='w-full max-w-4xl rounded-2xl bg-white p-6 shadow-xl ring-1 ring-gray-900/5 lg:p-10'>
      ...
      <div className='mt-8 space-y-6 text-sm leading-7 text-gray-700 lg:text-base'>
        <section>
          ...
          <p className='mt-2'>
            Esta Política de Privacidade descreve como a plataforma <strong>WhatsApp Business</strong> ("Plataforma", "nós")
            coleta, usa, armazena e protege dados pessoais quando você utiliza nossos serviços para conectar contas da Meta
            (Facebook/Instagram) e gerenciar mensagens via WhatsApp Business Platform.
          </p>
        </section>
        ...
        <section>
          ...
          <ul className='mt-2 list-disc space-y-1 pl-6'>
            ...
            <li>Dados das contas conectadas da Meta (IDs de conta, páginas, números do WhatsApp Business vinculados e permissões concedidas).</li>
        ...
        <section>
          ...
          <ul className='mt-2 list-disc space-y-1 pl-6'>
            ...
            <li>Conectar e manter integrações com a Meta e com a WhatsApp Business Platform.</li>
