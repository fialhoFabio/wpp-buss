...
export default async function LinkWhatsappAccount() {
  return (
    <div className='container mx-auto max-w-7xl space-y-6 px-6 pt-4 pb-6'>
      <div>
        <h1 className='text-3xl font-bold text-gray-900'>Vincular Conta do WhatBus</h1>
        <p className='mt-2 text-gray-600'>Conecte sua conta do WhatBus para começar a enviar mensagens.</p>
      </div>
